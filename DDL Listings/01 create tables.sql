...
(
	id        INT, --generated by sequence SaldoSequ
	accnt_id  INT,
	bnk_bic   VARCHAR(11),
	...
	amount    DECIMAL(17, 2), 
	primary key (id),
	foreign key (accnt_id,bnk_bic)
	references accounts(id,bnk_bic)
)
COMMENT 'Table with saldos per accounts, bank and customer';

CREATE COLUMN TABLE transactions
(
	id        INT, --generated by sequence TrnsSequ
	accnt_id  INT,
	bnk_bic   VARCHAR(11),
	slddate   DATE, --transaction date
	currency  VARCHAR(3), --Currency ISO Code
	amount    DECIMAL(17, 2), 
	primary key (id),
	foreign key (accnt_id,bnk_bic)
